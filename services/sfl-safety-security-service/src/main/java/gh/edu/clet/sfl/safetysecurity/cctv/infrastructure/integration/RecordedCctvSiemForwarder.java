 ...
 * forwarded rather than fabricating delivery - the same stance {@code RecordedCctvSiemForwarder} in
 * {@code accesscontrol} takes for its own exceptions. */
@Component
public class RecordedCctvSiemForwarder implements CctvSiemForwarderPort {

    private static final Logger log = LoggerFactory.getLogger(RecordedCctvSiemForwarder.class);
