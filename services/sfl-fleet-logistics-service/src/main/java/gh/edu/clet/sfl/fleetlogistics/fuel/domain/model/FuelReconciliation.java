 ...
 *
 * <p>Written on every run since S168 shipped, and until now unreadable - the rows existed in {@code
 * fleet_logistics.fuel_reconciliations} with no query behind them, so a screen could report that a
 * transaction failed but never which rules it passed. This record is what makes a decision
