...
import gh.edu.clet.sfl.fleetlogistics.assets.application.ServiceEventType;
import gh.edu.clet.sfl.fleetlogistics.assets.application.ServiceOutbox;
...
class JpaServiceOutbox implements ServiceOutbox {
    ...
    private final AssetOutboxMessageRepository outboxMessages;
    private final ObjectMapper objectMapper;
    private final Clock clock;

    JpaServiceOutbox(AssetOutboxMessageRepository outboxMessages, ObjectMapper objectMapper, Clock clock) {
    ...
    public void record(String eventType, int eventVersion, String aggregateType, UUID aggregateId,
        ...
        outboxMessages.save(new AssetOutboxMessageRecord(UUID.randomUUID(), eventType, eventVersion, aggregateType,
