...
public class AssetOutboxMessageRecord {
    ...
    protected AssetOutboxMessageRecord() {
    }

    public AssetOutboxMessageRecord(UUID id, String eventType, int eventVersion, String aggregateType,
