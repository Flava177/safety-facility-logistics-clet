...
/**
 * Public application boundary from S168_fuel to S166; fuel never reaches Fleet persistence
 * directly.
 */
public interface FuelFleetReferencePort {
    ...
    record Snapshot(
            long acceptedOdometer,
            String vehicleLifecycle,
            String vehicleAvailability,
            String driverEligibility,
            boolean tripMatches,
            String driverStaffReference) {}
}
