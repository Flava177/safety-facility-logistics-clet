...
public final class FuelPermissionMatrix {
    ...
    public static boolean grants(Set<SflRole> roles, SflPermission permission) {
        return roles != null
                && roles.stream()
                        .anyMatch(r -> MATRIX.getOrDefault(r, Set.of()).contains(permission));
    }
    ...
    private static Map<SflRole, Set<SflPermission>> build() {
        ...
        for (var p : SflPermission.values()) if (p.name().startsWith("FUEL_")) all.add(p);
        ...
        m.put(
                ...
                EnumSet.of(
                        ...
                        SflPermission.FUEL_LOGBOOK_SUBMIT,
        ...
        m.put(
                ...
                EnumSet.of(
                        ...
                        SflPermission.FUEL_LOGBOOK_SUBMIT));
        m.put(
                SflRole.FLEET_REPORTING_VIEWER,
                EnumSet.of(
                        SflPermission.FUEL_TRANSACTION_READ,
                        SflPermission.FUEL_LOGBOOK_READ,
                        SflPermission.FUEL_ANOMALY_READ,
