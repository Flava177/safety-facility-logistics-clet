...
public final class FuelPermissionMatrix {
    ...
    private static Map<SflRole, Set<SflPermission>> build() {
        ...
        m.put(SflRole.FLEET_LOGISTICS_OFFICER,EnumSet.of(SflPermission.FUEL_TRANSACTION_READ,SflPermission.FUEL_TRANSACTION_CAPTURE,SflPermission.FUEL_TRANSACTION_IMPORT,SflPermission.FUEL_POLICY_READ,SflPermission.FUEL_LOGBOOK_READ,SflPermission.FUEL_LOGBOOK_CREATE,SflPermission.FUEL_LOGBOOK_SUBMIT,SflPermission.FUEL_RECONCILIATION_RUN,SflPermission.FUEL_ANOMALY_READ,SflPermission.FUEL_ANOMALY_MANAGE,SflPermission.FUEL_REPORT_READ,SflPermission.FUEL_CARD_READ));
        ...
        m.put(SflRole.AUDITOR,EnumSet.of(SflPermission.FUEL_CARD_READ,SflPermission.FUEL_TRANSACTION_READ,SflPermission.FUEL_LOGBOOK_READ,SflPermission.FUEL_ANOMALY_READ,SflPermission.FUEL_REPORT_READ,SflPermission.FUEL_REPORT_EXPORT));
        m.put(SflRole.COMPLIANCE_OFFICER,EnumSet.of(SflPermission.FUEL_CARD_READ,SflPermission.FUEL_TRANSACTION_READ,SflPermission.FUEL_LOGBOOK_READ,SflPermission.FUEL_ANOMALY_READ,SflPermission.FUEL_ANOMALY_APPROVE,SflPermission.FUEL_REPORT_READ,SflPermission.FUEL_REPORT_EXPORT));
