...
/**
 * Outbound seam that surfaces material fuel exceptions to Finance and Audit. Implementations MUST
 * NOT write to any Finance database directly; visibility is delivered through the transactional
 * outbox so it is atomic with the state change.
 */
