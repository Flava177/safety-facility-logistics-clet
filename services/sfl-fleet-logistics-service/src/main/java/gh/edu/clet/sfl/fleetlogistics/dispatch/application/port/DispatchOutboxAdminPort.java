...
/**
 * Read/observe and replay port over the shared transactional outbox, so the dispatch integration surface
 * can expose outbound delivery health and privileged dead-letter replay without depending on messaging
 * infrastructure types directly.
 */
public interface DispatchOutboxAdminPort {
