...
public class FuelDashboardController {
    ...
    public FuelDashboardController(FuelApplicationService s, FleetActorResolver a) {
        service = s;
        actors = a;
    }

    @io.swagger.v3.oas.annotations.Operation(
            summary = "Returns the fuel operational dashboard snapshot for a site")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Actor lacks FUEL_REPORT_READ for the site")
    @GetMapping
     ...
     */
    @io.swagger.v3.oas.annotations.Operation(
            summary = "Returns fuel spend and volume aggregated by day for a site")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Actor lacks FUEL_REPORT_READ for the site")
    @GetMapping("/daily-totals")
    public ApiResponse<List<FuelRepository.DailyFuelTotals>> dailyTotals(
    ...
    @io.swagger.v3.oas.annotations.Operation(
            summary = "Returns open anomaly counts by type for a site")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Actor lacks FUEL_REPORT_READ for the site")
    @GetMapping("/anomaly-counts")
    public ApiResponse<Map<String, Long>> anomalyCounts(
            @RequestParam String siteCode, HttpServletRequest h) {
