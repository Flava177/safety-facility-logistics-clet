package gh.edu.clet.sfl.ifimp.maintenance.api;

import java.net.URI;
import java.util.List;
import java.util.UUID;

import gh.edu.clet.sfl.ifimp.maintenance.application.FacilityFaultService;
import gh.edu.clet.sfl.ifimp.maintenance.application.ReportFacilityFaultCommand;
...
@RestController
@RequestMapping("/api/v1/ifimp/facility-faults")
public class FacilityFaultController {
    ...
    public ResponseEntity<FacilityFault> report(
        ...
        return ResponseEntity.created(URI.create("/api/v1/ifimp/facility-faults/" + result.id())).body(result);
    }
