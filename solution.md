...
- `sfl-safety-security-service` - **SFL.SSEMP**, port 8092. S160 Visitor, S163 HSE Incident/Near-Miss and S160a Physical Access Control Integration are built in `safety_security`; S174 Emergency Notification is built in `emergency_notification`. S160a governs access policy, provisioning, overrides, SOC exceptions and occupancy over a recorded vendor gateway - see `accesscontrol` - and never controls a door itself. S161 CCTV, S162 Intrusion and S162a Life-Safety remain Buy-and-Integrate scope.
