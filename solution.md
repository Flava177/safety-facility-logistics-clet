...
- `sfl-safety-security-service` - **SFL.SSEMP**, port 8092. S160 Visitor, S160a Access Control, S161 CCTV, S162 Intrusion, S162a Life-Safety, S163 HSE (schema `safety_security`, sub-contexts `visitor`, `accesscontrol`, `cctv`, `intrusion`, `lifesafety`, `hse`) and S174 Emergency Notification (schema `emergency_notification`, package `..safetysecurity.emergency`). Only S174 is built.
