...
- **`sfl-safety-security-service`** - port 8092, schema `emergency_notification`, its own
...
… port 8092"* instead of always naming the fleet service. Default is `fleet`, so the three modules
