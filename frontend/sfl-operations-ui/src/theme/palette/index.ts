...
// SFL brand: navy is the primary surface colour, gold is the accent.
...
const chNavy = generatePaletteChannel(sflNavy);
const chGold = generatePaletteChannel(sflGold);
const chPurple = generatePaletteChannel(purple);
